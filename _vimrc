...
if(g:iswindows==1)
    let $TMP='D:/temp'
    let $AddonDir='C:\Users\Lubo\vim-addons\'
    let $AddonUtilDir=$AddonDir.'/binary-utils/dist'
    set directory=c:\Sync
...
"call LoadPlugin()
"""""Surround""""
call vam#ActivateAddons(['surround','Highlight_UnMatched_Brackets'],{'auto_install':0})
"""""""""""""""""
...
let g:vimwiki_list = [{'path': 'D:/vimwiki/',
    ...
    \ 'auto_export':1,
    \ 'template_path': 'D:/vimwiki/html/templates/',
...
""""calendar""""
let g:calendar_diary="C:\\Sync\\Diary"
